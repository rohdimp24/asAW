...
'''
unigramFile=prefixpath+"trienergyNgram/unigrams_all.csv"
dictUnigrams={}
...
'''
bigramFile=prefixpath+"trienergyNgram/bigrams_all.csv"
dictBigrams={}
...
'''
trigramFile=prefixpath+"trienergyNgram/trigrams_all.csv"
dictTrigrams={}
...
def getData(equipmentType,siteName,isDistinct=True):
    ...
    try:
       cursor = cnx.cursor()
       sqlQuery = "SELECT WO_Long_Desc FROM TrienergyWO"
       print(sqlQuery)
